...
(function () {
  ...
  const DEFAULT_LOCATIONS = [
    ...
    {
      name: "Bass Harbor Lighthouse",
      nearbyTown: "Bass Harbor (Village in Tremont), approx. 1 mile north. Bar Harbor is the main gateway town, approx. 18 miles (40 mins) away. Source: The Briny Babe.",
      state: "Maine",
      region: "Eastern States",
      lat: "44.2220194",
      lng: "-68.3374417",
      elevation: "Sea Level (0 ft). Source: Photographers Trail Notes.",
      trailDifficulty: "MODERATE (2.5 out of 5). The walk from the parking lot is an easy 100 yards, but the final descent involves a wooden stairway and then scrambling onto jagged, often slippery rocks. Source: Photographers Trail Notes.",
      bestTimeOfDay: "Sunset is the most popular and classic time for the iconic shot from the rocks. Arrive at least 2-3 hours early to secure a parking spot and a position for your tripod. Sunrise is also a great option for fewer crowds and different lighting, with the first light hitting the lighthouse face. Night photography/Milky Way is also popular from March to October during new moon phases. Source: Photographers Trail Notes and Photography Magazine Extra.",
      bestTimeOfYear: "Spring and Fall are recommended to avoid the heaviest summer crowds. Peak fall foliage typically occurs in the first 2-3 weeks of October. Milky Way season is March through October. Winter offers unique snowy/icy scenes but some roads may be closed. Source: KÜHL and Photography Magazine Extra.",
      photographyTips: "Arrive 2-3 hours before sunset to find a spot; the rock area is small and fills with tripods quickly. Experiment with composition: moving just a few feet changes the relationship between the lighthouse, boulders, and ocean. Use a low perspective to include tidal pools as a foreground element. Use a circular polarizer to either enhance or remove reflections in water. Don't just stand on the main rock; explore spots behind, below, or to the sides of the large boulder at the bottom of the steps. For Milky Way, visit during a new moon from March-Oct and aim for the darker southern sky. Source: Photographers Trail Notes and YouTube - David Johnson. The location is extremely popular and the small parking lot (approx. 24 spots) often fills up hours before sunset. Arriving 2-3 hours early is recommended to secure a spot and a tripod location on the rocks. The area for the classic shot is small (20ft x 30ft) and can be very crowded with other photographers. Movement on the jagged, slippery rocks is challenging and requires caution. The lighthouse is the 5th most visited site in Acadia. Source: Photographers Trail Notes and Photography Magazine Extra.",
      shotDirection: "The classic shot from the rocks looks North/Northwest towards the lighthouse (lighthouse is on a cliff facing South/Southwest). Source: Photographers Trail Notes.",
      lensesNeeded: "Wide-angle lens (16-35mm is highly recommended) to capture the lighthouse and rocky foreground. Mid-range zooms (24-70mm) are also useful. Source: Photographers Trail Notes.",
      equipmentNeeded: "Sturdy tripod (essential for long exposures and stability on rocks), circular polarizer (to manage reflections in tide pools and glare on water), ND filters (for long exposure/milky water effects), red headlamp for night/milky way shoots, and sturdy, non-slip footwear. Source: Photographers Trail Notes and I Hit The Button.",
      permits: "Acadia National Park entrance fee/pass required (typically $35 per vehicle for 7 days). Commercial photography may require a Special Use Permit. Source: Photography Magazine Extra.",
      directions: "From Bar Harbor, it is approximately a 30-40 minute drive. Take Route 102 south towards Southwest Harbor, then continue on Route 102A towards Bass Harbor. Follow signs for Bass Harbor Head Light Station. From the parking lot, a gravel path on the eastern edge leads through the woods to a wooden platform. To get the classic 'icon' shot, follow the path to the left of the buildings, bear right to a stairway that descends the cliff face to the rocks below. Source: New England Wanderlust and The Briny Babe.",
      camping: "Lamoine State Park and various private campgrounds on Mount Desert Island (near Bar Harbor and Southwest Harbor). No backcountry camping is permitted in Acadia. Source: The Briny Babe.",
      lodging: "Hotels and inns are available in nearby Bar Harbor (e.g., Asticou Inn, Gardiner House) and Southwest Harbor. Source: The Briny Babe.",
      restaurants: "Jordan Pond House (known for popovers), Trenton Bridge Lobster Pound, Peekytoe Provisions, and various options in Bar Harbor and Southwest Harbor. Source: The Briny Babe.",
      cellService: "Available but can be spotty in the park. Source: Photographers Trail Notes.",
      weather: "Weather can change quickly; fog is common and can roll in suddenly. Coastal winds can make it feel much cooler. Check tides as high surf can make the rocks dangerous. Source: Photography Magazine Extra.",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/bass-harbor-lighthouse",
      photos: []
    },
    {
      name: "Bass Harbor Marsh",
      nearbyTown: "Bar Harbor, ME Source: Photographers Trail Notes",
      state: "Maine",
      region: "Eastern States",
      lat: "44.2534167",
      lng: "-68.3406667",
      elevation: "Sea Level Source: Photographers Trail Notes",
      trailDifficulty: "Easy (Rated 1.5 on a scale of 1-5). Source: Photographers Trail Notes",
      bestTimeOfDay: "Excellent spot at sunset as the sun descends over the marsh and ducks behind the trees. Source: Photographers Trail Notes",
      bestTimeOfYear: "Best from June through Early September. From mid-September through mid-May, the sun's position changes. Source: Photographers Trail Notes",
      photographyTips: "Use a 3-stop soft-edged graduated neutral density filter to balance sky brightness. Sample EXIF: 24mm, 1/60th sec @ f/8.0, ISO 100, taken June 10th at 7:45 pm. Source: Photographers Trail Notes The page content was partially restricted by a login modal, but I was able to extract significant details from the initial load. On busy days, expect 3-4 photographers, or more if a workshop is present. The marsh is located right along Route 1. Source: Photographers Trail Notes",
      shotDirection: "North by Northeast at 345°. Source: Photographers Trail Notes",
      lensesNeeded: "Wide angle to standard lenses (16-35mm, 24-70mm). The featured image was taken with a 24mm lens. Source: Photographers Trail Notes",
      equipmentNeeded: "Sturdy tripod; no other special equipment needed. Source: Photographers Trail Notes",
      permits: "No permits required in the area. Source: Photographers Trail Notes",
      directions: "Located right along Route 1. From Bar Harbor: take Route 233/Eagle Lake Road west to Route 3. Make a right onto Route 3 and follow to Route 1. Source: Photographers Trail Notes",
      camping: "Blackwoods Campground (Acadia) Source: Photographers Trail Notes",
      lodging: "Edgewater Motel & Cottages (137 Old Bar Harbor Rd., Bar Harbor); Bar Harbor Grand Hotel (269 Main St, Bar Harbor). Source: Photographers Trail Notes",
      restaurants: "Beal’s Lobster Pier (182 Clark Point Rd, Southwest Harbor); Thurston’s Lobster Pound (9 Thurston Rd, Bernard, ME). Source: Photographers Trail Notes",
      cellService: "Spotty on the island (tested with Verizon). Source: Photographers Trail Notes",
      weather: "Pleasant in fall and spring; mild in summer; brutally cold in winter. Source: Photographers Trail Notes",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/bass-harbor-marsh",
      photos: []
    },
    {
      name: "Bennett-Bean Bridge",
      nearbyTown: "Wilsons Mills (Lincoln Plantation), ME (approx. 1.5 miles north). Wikipedia",
      state: "Maine",
      region: "Eastern States",
      lat: "44.917778",
      lng: "-71.039167",
      elevation: "1,267 Ft. Photographers Trail Notes",
      trailDifficulty: "EASY; simply pull off the road and walk a short distance to the desired vantage point. Photographers Trail Notes",
      bestTimeOfDay: "Around 7:00 AM, just after sunrise. At this time, the bridge itself may still be in shadow while the background trees are illuminated, creating a nice contrast. Photographers Trail Notes",
      bestTimeOfYear: "Autumn, specifically early to mid-October for peak fall foliage. New England Fall Foliage",
      photographyTips: "Walk around the banks of the Magalloway River to find different angles. Avoid going too wide, as it can push the scenic background hills too far back in the frame. Using a 70mm focal length helps emphasize the color of the surrounding trees and tucks the bridge into the landscape. If shooting shortly after sunrise, use a graduated ND filter to manage the bright sky and trees while the bridge remains in shadow. Photographers Trail Notes The Bennett-Bean Bridge is one of Maine's older covered bridges, featuring a classic Paddleford Truss design. It was added to the National Register of Historic Places in 1970 and closed to traffic in 1985. It underwent a significant restoration in 2005. Photographers Trail Notes, Gribblenation",
      shotDirection: "Easterly. Facebook / Rick Berk",
      lensesNeeded: "Standard length zoom lenses (e.g., 24-70mm). Using the longer end (around 70mm) is recommended to compress the perspective and bring the background hills closer to the bridge. Photographers Trail Notes",
      equipmentNeeded: "Tripod, soft 2-stop graduated neutral density (GND) filter to control tree brightness against the shaded bridge. Photographers Trail Notes",
      permits: "Generally none required for visiting or still photography as it is a historic landmark; however, film production may require a Special Use Permit in Maine. Emerge Film Solutions",
      directions: "From Maine Route 16, turn onto Littlehale Road (near the New Hampshire/Maine border). The bridge will come into view shortly after turning. You can pull off to the side of the road and walk to the bridge. Photographers Trail Notes",
      camping: "Aziscoos Valley Campgrounds is located right next to the bridge; the bridge is actually situated at the back of the campground. New England Fall Foliage",
      lodging: "Limited local options in Wilsons Mills; more traditional lodging available in nearby Errol, NH. Yelp",
      restaurants: "The Hungry Trout and Portage Tap House are notable nearby options. Yelp",
      cellService: "Spotty and unreliable; users have reported needing to pre-plot directions as signals are weak in the valley. New England Fall Foliage",
      weather: "Misty or foggy mornings are common and can provide atmospheric conditions for photography. Rick Berk Photography",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/bennett-bridge",
      photos: []
    },
    {
      name: "Boulder Beach",
      nearbyTown: "Bar Harbor, ME (Approx. 5-6 miles). (Chasing Hippoz)",
      state: "Maine",
      region: "Eastern States",
      lat: "44.3197222",
      lng: "-68.185",
      elevation: "Sea Level (0 ft). (Photographers Trail Notes)",
      trailDifficulty: "EASY (Rating: 2/5). The walk from the Ocean Path is short but involves a slight incline and a scramble over large, slick boulders. Navigate carefully as rocks can shift or tilt. (Photographers Trail Notes)",
      bestTimeOfDay: "Sunrise. Each morning the sun rises over the Atlantic and casts its warm glow on the smooth, rounded boulders. Arrive at least 45-60 minutes before sunrise to secure a spot and prepare. Predawn darkness requires a headlamp for the scramble. (Photographers Trail Notes)",
      bestTimeOfYear: "Year-round, though peak foliage (late September to mid-October) is very popular but crowded. Summer offers pleasant weather but higher tourist volume. Winter can be icy and dangerous on the rocks. (Chasing Hippoz)",
      photographyTips: "Find a location along the beach that complements the sunrise, clouds, and lens focal length. Experiment with different tripod heights—getting low can exaggerate the size of the boulders. Use a fast shutter speed (1/1000s) to freeze wave splashes or long exposures (8+ seconds) with an ND filter to smooth out the Atlantic. The true impact of the image depends on wave action; when the tide moves in/out, the boulders can make a 'popping' sound. Be aware that rocks are very slick and some may be loose/shift when stepped on. (Photographers Trail Notes) (Dan M Lee Photography) (I Hit The Button) The exact coordinates provided in the snippet were partially masked (xx°27'5.80\\\"N xxx°50'16.64\\\"W). The values provided are the standard coordinates for Boulder Beach in Acadia NP. The site mentions 'Sea Level Ft.' for elevation. The popping sound of the rocks in the tide is a unique feature. The nearby town of Bar Harbor is the primary gateway to the park. The 'Ocean Path' is the main access trail. The location is famous for sunrise shots looking over the Atlantic.",
      shotDirection: "East/Northeast (toward the sunrise over the Atlantic Ocean). Otter Cliffs lie to the South/Southeast of the beach. (Instagram) (Photographers Trail Notes)",
      lensesNeeded: "Wide-angle (15-35mm) for sweeping coastal vistas and medium telephoto (70-200mm) for compressed, layered shots of the islands or isolating Otter Cliffs. (Photographers Trail Notes) (I Hit The Button)",
      equipmentNeeded: "Sturdy tripod (essential for long exposures), ND filters (6-stop or 10-stop for blurring wave motion), Circular Polarizer (to cut glare and bring out colors), Graduated ND filter (to balance bright horizons at sunrise), and a headlamp (red mode preferred for predawn access). (Photographers Trail Notes) (Nature TTL)",
      permits: "Acadia National Park entrance fee ($30/vehicle for 7 days or use America the Beautiful pass). Some commercial photography or large groups may require a Special Use Permit. (Dan M Lee Photography)",
      directions: "Park where Otter Cliff Rd and Park Loop Rd meet on the east side of the island. Walk toward the shoreline and descend from the Ocean Path. A short drop-down and scramble over some large rocks lead to the beach. (Dan M Lee Photography) (Photographers Trail Notes)",
      camping: "Blackwoods Campground is the closest within the park. Other options include Seawall Campground and private campgrounds near Bar Harbor. (Scampgrounds)",
      lodging: "Numerous hotels and inns are located in Bar Harbor, approximately 5-6 miles away. Staying in Bar Harbor or Northeast Harbor provides the best access to the park's east and west sides. (Chasing Hippoz)",
      restaurants: "Numerous options in Bar Harbor (e.g., lobster rolls, seafood). Jordan Pond House is a popular in-park dining option (famous for popovers). (Chasing Hippoz)",
      cellService: "Variable. Generally available along the Park Loop Road but can be spotty in low-lying coastal areas. (Photographers Trail Notes)",
      weather: "Best in clear or partly cloudy conditions for sunrise color. Stormy weather can create dramatic surf, but use caution as wet rocks are extremely slippery. Check tide charts as the beach and boulders are heavily influenced by the tide height. (Nature TTL)",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/boulder-beach",
      photos: []
    },
    {
      name: "Cape Porpoise Reflection",
      nearbyTown: "Near Kennebunkport, ME Photographers Trail Notes",
      state: "Maine",
      region: "Eastern States",
      lat: "43.3669167",
      lng: "-70.4360833",
      elevation: "Sea Level Ft. Photographers Trail Notes",
      trailDifficulty: "EASY. It is an easy walk along Langsford Road with various vantage points. Respect community residents and property. There is a muddy path for a lower vantage point. Photographers Trail Notes",
      bestTimeOfDay: "Decidedly a sunrise location. In the early morning, before human activity creates turbulence in the air and water, the reflections are best. The reference image was taken at sunrise. Photographers Trail Notes",
      bestTimeOfYear: "Fall and winter are best because the sun rises behind the house when facing it from Langsford Road, creating backlighting. The reference image was taken on December 22nd. Photographers Trail Notes",
      photographyTips: "The shot is best taken from a position on the street (Langsford Road) between two fish houses, slightly zoomed in to isolate the Cape Porpoise Fish House. A lower vantage point can be reached via a muddy path leading to the water's edge for different reflections. EXIF data for the reference image: Focal Length - 53mm, Exposure - 1/8th sec @ f/8.0, ISO - 100, Date - Dec 22nd, Time - sunrise. Photographers Trail Notes The Cape Porpoise Fish House is a popular location for photographers, especially since its newer incarnation was built. It is an oddity along the Maine coast, located in a fishing harbor. The area can have a few photographers on busy days. It is important to respect the community's residents and property. Verizon cell service is available. Nearby resources include Visit Maine - Kennebunkport and the Kennebunkport town website. Rick Berk, a landscape photographer with 25 years of experience, offers private and group workshops in the area. The image used as a reference on the page was taken on December 22nd. Rick Berk Visit Maine - Kennebunkport Kennebunkport Town Website",
      shotDirection: "South, around 170°. Photographers Trail Notes",
      lensesNeeded: "Zooms such as a 24-70mm are perfect to isolate the fish house or capture the wider scene. The reference image was taken at 53mm. Photographers Trail Notes",
      equipmentNeeded: "Sturdy tripod, potentially a polarizing filter, and a neutral density filter. Muck boots or waders are helpful if walking in the mud near the water's edge. Photographers Trail Notes",
      permits: "There are no permits required in the area. Photographers Trail Notes",
      directions: "From Kennebunkport, drive on State Rte 9 E for 2.0 miles, then turn right on Main St, and follow the road to Langsford Road. Detailed directions are available via a Google Maps link. Photographers Trail Notes",
      camping: "",
      lodging: "Kennebunkport has many great places to eat and relax; specific lodging is not listed but the town is a well-known destination. Photographers Trail Notes",
      restaurants: "Old Vines Wine Bar (173 Port Rd Kennebunk, ME, (978) 483-0715) and Mabels Lobster Claw (124 Ocean Ave Kennebunkport, (207) 967-2562). Photographers Trail Notes",
      cellService: "Verizon cell service is available at this location. Photographers Trail Notes",
      weather: "Weather considerations include checking for turbulence in the air/water for reflections. Current Weather. Photographers Trail Notes",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/cape-porpoise-reflection",
      photos: []
    },
    {
      name: "Castle Hill Lighthouse",
      nearbyTown: "Newport, RI (approx. 4 miles)",
      state: "Rhode Island",
      region: "Eastern States",
      lat: "41.465084",
      lng: "-71.360664",
      elevation: "Sea Level (0-40 Ft). LatLong.net, NOAA",
      trailDifficulty: "EASY (Rating 1-2 out of 5). Short walk from the parking area. The only danger is venturing onto the slippery rocks beyond the lighthouse. Photographers Trail Notes Preview",
      bestTimeOfDay: "Sunset (hour before and after). Arrive in advance to scout compositions on the rocks. Dave Long Photo",
      bestTimeOfYear: "Any time of year. In winter, shot direction is best north to south; in summer, south to north. Dave Long Photo",
      photographyTips: "Make sure to arrive in advance of sunset with enough time to scout a composition on the rocks. Try to incorporate the action of the ocean against the rocks; you need to be on site to see what works best for a given sunset. A certain tidal situation can create a special photographic opportunity for the left side of the lighthouse. If you move further back, the base of the lighthouse may be obscured. Use long exposures to capture wave motion. Photographers Trail Notes Preview The information was extracted from the preview page and supplemented with external sources due to member-only access on the main page. The photography tips and trail difficulty descriptions are based on the available snippets. Coordinates and elevation were verified via multiple sources. Nearby town and state were confirmed. Details on permits, directions, camping, and lodging were gathered from local guides and visitor reports.",
      shotDirection: "Westerly facing for sunset. North to south in winter; south to north in summer. Dave Long Photo",
      lensesNeeded: "Ultra wide to wide angle (12mm - 35mm). The lighthouse is small and built into the rocks, requiring a close position for full capture. Photographers Trail Notes Preview",
      equipmentNeeded: "Tripod for long exposures, ND filters to smooth water, sturdy footwear for scrambling on rocks. Photographers Trail Notes Preview",
      permits: "The lighthouse is adjacent to the private property of Castle Hill Inn. Public access is generally tolerated via the trail, but professional/commercial photography (weddings, etc.) is reserved for Inn patrons. Castle Hill Inn FAQs",
      directions: "From Newport, take Ocean Drive to Castle Hill Inn (590 Ocean Dr). Park in the Inn's parking lot and follow the trail (sometimes marked as private) down to the rocks where the lighthouse is located. Yelp",
      camping: "No camping at the lighthouse. Nearby options include Melville Pond Campground in Portsmouth (~15 miles) or Fishermen's Memorial State Park in Narragansett (~20 miles). Google Maps",
      lodging: "Castle Hill Inn (on-site). Numerous hotels and B&Bs in Newport. Castle Hill Inn",
      restaurants: "The Dining Room at Castle Hill Inn (on-site). Extensive dining options in downtown Newport. Yelp",
      cellService: "Good cell service available in the Newport/Castle Hill area. Visitor Reports",
      weather: "Best on clear or partly cloudy days for sunset. Fog can provide moody atmosphere but may obscure the lighthouse. Yelp",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/castle-hill",
      photos: []
    },
    {
      name: "Cutler Bold Coast (Cutler Coast Public Reserved Land)",
      nearbyTown: "Cutler, ME and Whiting, ME (approx. 2 hours from Bar Harbor). (Photographers Trail Notes)",
      state: "Maine",
      region: "Eastern States",
      lat: "44.698689",
      lng: "-67.158178",
      elevation: "150 ft at certain points along the coastal cliffs. (Photographers Trail Notes)",
      trailDifficulty: "Rated 3.5/5 (Difficult). The trail is rocky, heavily covered in tree roots, and can be extremely muddy after rain. It features many wood boardwalks in varying states of repair. (Photographers Trail Notes)",
      bestTimeOfDay: "Sunrise and sunset are highly recommended for the best light on the headlands. Early morning light or sunset colors reflecting on the rugged cliffs and water provide excellent compositions. Foggy conditions are also common and can add a sense of mystery to the coastline. (Only In Your State, Photographers Trail Notes)",
      bestTimeOfYear: "Best between May and October to avoid difficult weather. Late summer is excellent for wildflowers like yellow clintonia and various bog plants. (Only In Your State, Hike New England)",
      photographyTips: "Utilize long exposures (e.g., 25 seconds) to smooth water and capture moving fog for a moody atmosphere. Use a polarizer to reduce glare on the water surface and cut through fog-induced haze. Focus on the rugged headlands and steep cliffs overlooking the Bay of Fundy. Wide-angle shots work well for the expansive coastline, while standard lengths (around 50mm) are good for isolating sections of the cliffs. The area is a dark-sky location, making it suitable for Milky Way photography. (Photographers Trail Notes, Reddit) The area is known for being Maine 'untouched'—wild, rocky, and less crowded than Acadia National Park. Wildlife includes moose, deer, grouse, eagles, falcons, owls, and marine mammals like whales, porpoises, and seals. Unusual plants like Hooker's iris and dragon's mouth orchid grow here. The Inland Trail can be flooded and difficult after rain. (Photographers Trail Notes, Maine.gov)",
      shotDirection: "Generally East or Southeast from the headlands overlooking the Bay of Fundy. (Photographers Trail Notes)",
      lensesNeeded: "Wide-angle to standard zooms are ideal for landscape shots. Telephoto lenses are useful for eagles, osprey, and marine life, but weight should be considered for the long hike. (Photographers Trail Notes)",
      equipmentNeeded: "Tripod for long exposures, circular polarizer to reduce glare and haze, and a lighter pack due to the extensive hiking (7-11 miles). Binoculars are recommended for wildlife viewing. (Photographers Trail Notes, Tripadvisor)",
      permits: "No fees are required for the use of the preserve. A sign-in sheet is located at the trailhead. (Photographers Trail Notes, Maine.gov)",
      directions: "From East Machias: Turn right onto Route 191 and proceed 16.9 miles (3 miles past Cutler village) to the trailhead and parking area. From North (Lubec/Whiting): Take Route 189 to Route 191, turn left and travel 10 miles to the parking area. Parking is limited to 20 cars. (Maine.gov)",
      camping: "Five primitive, first-come, first-served campsites are available along the trail: Black Point Cove, Fairy Head (3 sites), and Long Point. (Maine.gov)",
      lodging: "Nearby options may be found in Machias or Lubec. (Tripadvisor)",
      restaurants: "Riverside Takeout in Machias (known for crab rolls) and Pat's Pizza. Note that most local businesses close early, around 7 or 8 PM. (Tripadvisor)",
      cellService: "Described as a 'remote' and 'wilderness' area, suggesting cell service may be limited or unavailable in many sections of the preserve. (Hike New England)",
      weather: "Expect fog, which is common along the coast. Muddy conditions persist after heavy rain. May to October offers the best weather for hiking and photography. (Photographers Trail Notes, Only In Your State)",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/cutler-bold-coast",
      photos: []
    },
    {
      name: "Dolly Sods Overlook",
      nearbyTown: "Davis, WV (approx. 28 miles / 1 hour drive); Thomas, WV is also nearby. Photographers Trail Notes",
      state: "West Virginia",
      region: "Eastern States",
      lat: "39.0659722",
      lng: "-79.3016667",
      elevation: "4,123 ft at the highest point; the overlook area is approximately 4,000 ft. Photographers Trail Notes",
      trailDifficulty: "Easy (rated 2/5). Requires a 5 to 30-minute walk from the parking area on well-worn but narrow and potentially muddy trails. Some boulder scrambling is optional. Photographers Trail Notes",
      bestTimeOfDay: "Sunrise and Sunset. The primary vantage points on the exposed ridge face east, making it ideal for sunrise. However, there are many compositions available for sunset by scouting westerly-facing views away from the ridge. Photographers Trail Notes",
      bestTimeOfYear: "Early October is considered the best time for peak autumn colors, especially the bright red huckleberry and blueberry bushes (specifically around October 4th). Early summer is good for flora, and late summer for blueberries. Photographers Trail Notes, Backpacker Magazine",
      photographyTips: "Scout the area a day in advance to find compositions involving stunted spruce trees, huckleberry bushes, and wind-carved boulders. For sunset, focus on westerly-facing compositions. Use The Photographer's Ephemeris (TPE) to plan for sun/moon alignments. Wide-angle lenses are preferred for sweeping vistas, but telephotos are useful for isolating details. Be prepared for high winds—sturdy tripod placement is essential. Expect large crowds (potentially hundreds of photographers) during peak fall weekends. Photographers Trail Notes The location is a high-altitude plateau characterized by stunted red spruce, ancient sphagnum bogs, and wind-carved boulders. It is the highest plateau east of the Mississippi. Pants are recommended even in summer due to narrow trails and brush. Trails can be very muddy ('mushy') after rain. Be prepared for strong wind gusts and significantly colder temperatures than the surrounding valleys. The area is large and can accommodate many photographers, but parking at Bear Rocks fills quickly during peak times (like early October). Photographers Trail Notes",
      shotDirection: "Almost due East (approx. 90°) for the classic ridge views. Photographers Trail Notes",
      lensesNeeded: "",
      equipmentNeeded: "Tripod, Polarizing Filter, and Graduated Neutral Density (GND) Filters. Photographers Trail Notes",
      permits: "None required. Photographers Trail Notes",
      directions: "From Davis, WV: Cross the bridge over Blackwater River and travel 11.1 miles south on Route 32. Take a sharp left onto Lanesville Rd (look for a small brown sign for Dolly Sods 500 ft before the turn). Follow Lanesville Rd for 5.8 miles to the Red Creek Wilderness parking. Pass through the open metal gate onto gravel road Route 19/75. Continue for 11.1 miles to the Bear Rocks Preserve parking area. Photographers Trail Notes",
      camping: "Red Creek Campground (located within the wilderness area), Blackwater Falls Campground. Photographers Trail Notes",
      lodging: "Black Bear Resort (Davis, WV), Canaan Valley Resort (Davis, WV), and various VRBO/Airbnb options in the Davis/Thomas area. Photographers Trail Notes",
      restaurants: "In Davis: Sirianni’s (Italian/Pizza), Big Belly Deli (Sandwiches), Trailhead Coffee Shop, Stumptown Ales. In Thomas: The Purple Fiddle (Food/Live Music). Photographers Trail Notes",
      cellService: "Spotty at best (Verizon reported as spotty). Service is generally available once back in the nearby towns of Davis or Thomas. Photographers Trail Notes",
      weather: "Unique micro-climate; expect conditions to be colder and windier than surrounding areas. Fog is common in the mornings. Trails become very muddy after rain. Photographers Trail Notes, Silver Spring Camera Club",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/dolly-sods",
      photos: []
    },
    {
      name: "Doubling Point",
      nearbyTown: "Bath, ME (approximately 2-3 miles)",
      state: "Maine",
      region: "Eastern States",
      lat: "43.8825",
      lng: "-69.8068056",
      elevation: "Sea Level Photographers Trail Notes",
      trailDifficulty: "EASY. Visitors can drive almost directly to the keeper's house where there is limited parking for 3-4 cars. The trail to the lighthouse is level and easy, though the marshy areas around the lighthouse can be muddy and underwater during high tides. Photographers Trail Notes",
      bestTimeOfDay: "Sunrise and Sunset. The lighthouse is side-lit in the morning. Low tide is highly recommended to expose the marshy foregrounds and pools for reflections. Photographers Trail Notes, Martin Belan",
      bestTimeOfYear: "Year-round, with late spring and summer being particularly popular for photography. Winter offers unique opportunities with ice floes on the Kennebec River, though access may be more difficult. Rick Berk, Maine Lights Today",
      photographyTips: "Shoot at low tide or as the tide is coming in to utilize the marshy areas for unique foregrounds. Look for puddles in the grass or mud to capture mirror-like reflections of the lighthouse. A wide-angle lens (e.g., 16mm) is perfect for including the walkway and the lighthouse together. Be extremely mindful of the tide, as high tides can quickly inundate the marshy areas north and south of the tower. Morning light provides good side-lighting on the tower. The Bath Iron Works can be seen upriver and can sometimes be included in background compositions. Photographers Trail Notes, Steph Purk The lighthouse is located on private property; visitors are asked to respect the privacy of the residents and strictly adhere to the 9 AM - 5 PM access hours. Security cameras are in use. The arched walkway to the lighthouse famously collapsed in September 2023, so check for current closure or repair status before visiting. A sign at the beginning of the walkway historically read \"Enter At Your Own Risk.\" New England Lighthouses, Photographers Trail Notes",
      shotDirection: "Northwest (looking toward the lighthouse from the marsh/walkway area). Google Maps",
      lensesNeeded: "Wide angle and standard length lenses. Wide-angle lenses in the 14-16mm range are ideal for capturing the lighthouse and its walkway. Photographers Trail Notes",
      equipmentNeeded: "Tripod (essential for long exposures and low-light shots), waterproof boots (highly recommended for venturing into the marshy areas north or south of the lighthouse), and circular polarizers or ND filters to manage the white shingles and water reflections. Photographers Trail Notes, Martin Belan",
      permits: "Free public access to the grounds is allowed from 9:00 AM to 5:00 PM. To visit outside these hours (for sunrise or late sunset shots), you must email lighthouse@doublingpoint.org to request permission. Photographers Trail Notes, TravelMaine",
      directions: "From US Route 1 in Bath, cross the Kennebec River Bridge and turn south onto Highway 127 (Five Islands Road). Drive for approximately 1.8 to 2 miles, then turn right onto Whitmore's Landing Road. After 0.4 miles, turn left onto Doubling Point Road (a private, narrow dirt road). Follow Doubling Point Road to the end, bearing right at the fork to reach the lighthouse parking area. TravelMaine, NE Lights",
      camping: "Meadowbrook Camping Area and Hermit Island Campground in nearby Phippsburg; camping is also available at Reid State Park. Benjamin Williamson",
      lodging: "Residence Inn Bath Brunswick Area and various B&Bs in the historic district of Bath. Orbitz",
      restaurants: "Winnegance Restaurant and Bakery (1.4 mi), The Cabin (1.6 mi), Mae's Cafe and Bakery (2.1 mi), and J R Maxwell & Co. Tripadvisor",
      cellService: "Generally available due to the proximity to the city of Bath. Tripadvisor",
      weather: "The location is subject to coastal fog, which can add significant atmosphere to photos. The Kennebec River is tidal, and fast-moving ice floes are common in the winter. Maine Lights Today",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/doubling-point",
      photos: []
    },
    {
      name: "Dunloup Creek Falls",
      nearbyTown: "Oak Hill, WV (approx. 8 miles away); also near Thurmond, WV.",
      state: "West Virginia",
      region: "Eastern States",
      lat: "37.9381944",
      lng: "-81.0974444",
      elevation: "1,355 Ft.",
      trailDifficulty: "EASY (1.5 out of 5). Parking is available along Thurmond Road (CR-25). There is a short, rocky scramble down to the creek bed from the road.",
      bestTimeOfDay: "Early morning or late afternoon are best, when direct sunlight isn't shining into the gorge. Cloudy days are even better due to the flat, even light the clouds help create.",
      bestTimeOfYear: "While late spring provides the heaviest flow due to snow melt and summer offers lush greenery, the location is stunning in the fall (around late October) when foliage turns gold, orange, and red, and fallen leaves decorate the rocks. The main image on the page was taken on Oct 26th.",
      photographyTips: "Walking into the creek is recommended for the best vantage point, but be extremely careful as the sandstone bottom is covered in a layer of slime, making it very slippery (worse than ice). Micro spikes are highly recommended for traction. Using a 4-stop neutral density filter is advised to achieve a slower shutter speed for silky-looking water. The water is typically shallow (around an inch deep depending on flow), allowing you to get very close to the falls. EXIF data for the sample shot: 16mm, 1 sec @ f/8.0, ISO 100 on Oct 26th. Dunloup Creek Falls is a 20-foot tall waterfall and a beautiful roadside attraction within the New River Gorge National Park and Preserve. It is a relatively isolated spot, located 8 miles from US-19. You might see a few other photographers at this location. Photos and summary are by Rick Berk. Nearby resources include Mountain State Waterfalls and West Virginia Waterfalls.",
      shotDirection: "The direction of the shot is north around 12°.",
      lensesNeeded: "Wide angle (16-35mm) and standard length (24-70mm) lenses are perfect. A longer lens can be used for detail shots. The main image was taken at 16mm.",
      equipmentNeeded: "Micro spikes for traction on the slippery creek bed and a neutral density filter to manipulate exposure for longer shutter speeds.",
      permits: "No permits are required in the area.",
      directions: "From Charleston, WV: Drive on I-64 east/I-77 south for 40 miles and take exit 60 for WV-612 toward Mossy/Oak Hill. Drive 14.5 miles and turn right onto Scarbro Rd. Drive toward Glen Jean and then turn left onto Thurmond Road (CR-25). Drive for 4.3 miles and Dunloup Creek Falls will be on the right. Google Maps Directions",
      camping: "New River Gorge National Park Camping offers limited primitive camping areas located along the river. These have no drinking water or hookups and limited restroom facilities.",
      lodging: "The closest town is Oak Hill, WV, which has several hotels including: Comfort Inn New River (801 Mall Rd) and Holiday Lodge Hotel (340 Oyler Ave).",
      restaurants: "In Oak Hill, WV: Cafe One Ten (110 Main St) and Heart Of Gold Diner (1550 E Main St).",
      cellService: "Cell service is spotty.",
      weather: "Check the Current Weather via the National Weather Service.",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/dunloup-creek-falls",
      photos: []
    },
    {
      name: "East of Eden",
      nearbyTown: "Bar Harbor, ME (8 miles) Photographers Trail Notes",
      state: "Maine",
      region: "Eastern States",
      lat: "44.4247056",
      lng: "-68.3267694",
      elevation: "Sea Level Photographers Trail Notes",
      trailDifficulty: "EASY (1/5). The spot is an easy 100 ft walk from the pull-out, though you will need to walk through some bushes. Photographers Trail Notes",
      bestTimeOfDay: "Sunrise and early morning. It is best just as the sun crests the horizon, when trees on the far side of the river are illuminated with a soft glow. Early morning mist or fog can provide a \"dreamy\" look. Photographers Trail Notes",
      bestTimeOfYear: "Picturesque year-round, but at its best in the fall when the colors of trees and bushes are vibrant. The reference image was captured on October 11th. Photographers Trail Notes",
      photographyTips: "The location offers many perspectives and angles. Moving east or west from the pull-out changes the perspective of the tributary's \"S\" curve, causing it to widen or contract. Composition can range from wide-angle to short telephoto. Technical details from the sample shot: Focal Length: 35mm, Exposure: 1/10th sec @ f/8.0, ISO: 100. Photographers Trail Notes The location is within Acadia National Park, often referred to as the \"Crown Jewel of the North Atlantic Coast.\" It features a tributary off the Eastern Bay that offers picturesque \"S\" curves, especially beautiful during the fall season with morning mist. At sunrise, you are likely to have the location to yourself, though it may attract casual passersby during the day due to its visibility from the road. Photographers Trail Notes",
      shotDirection: "South by southeast (approximately 140°). Photographers Trail Notes",
      lensesNeeded: "",
      equipmentNeeded: "A tripod is recommended. No other special photography equipment is necessary unless planning for long exposures or using filters. Photographers Trail Notes",
      permits: "No permits are required at this location. Photographers Trail Notes",
      directions: "From Bar Harbor, drive 8 miles on Bar Harbor Rd / ME-3 W. You will pass through the communities of Hulls Cove, Salsbury Cove, and Eden. The location is on the south side of the road, featuring a small tributary off of the Eastern Bay, approximately 1/2 mile past Eden. There is a pull-out for about 3-4 cars just past the location on the east side. Photographers Trail Notes",
      camping: "Blackwoods Campground in Acadia National Park is a nearby option. Photographers Trail Notes",
      lodging: "Nearby options include the Edgewater Motel & Cottages (137 Old Bar Harbor Rd.) and the Bar Harbor Grand Hotel (269 Main St.) in Bar Harbor. There are also many VRBO and Airbnb options in the area. Photographers Trail Notes",
      restaurants: "Nearby options in Bar Harbor include West Street Cafe (76 W St.), Side Street Cafe (49 Rodick St.), and Trenton Bridge Lobster Pound (1237 Bar Harbor Rd, Trenton), which is a traditional lobster house. Photographers Trail Notes",
      cellService: "Cell service is good with Verizon at this location, though it can be spotty in other areas of Acadia National Park. Photographers Trail Notes",
      weather: "Weather in Acadia is pleasant in the Fall and Spring, and mild during the summer. Photographers Trail Notes",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/east-of-eden",
      photos: []
    },
    {
      name: "Elakala Waterfall",
      nearbyTown: "Davis, WV (approx. 2-3 miles) and Thomas, WV (Mountain State Waterfalls, Islands).",
      state: "West Virginia",
      region: "Eastern States",
      lat: "39.107303",
      lng: "-79.499337",
      elevation: "2,900 - 3,092 Ft. (Photographers Trail Notes, Mountain State Waterfalls)",
      trailDifficulty: "EASY (Rating: 2/5). A short 5-minute walk (0.2 - 0.6 miles round trip) to the bridge. The descent into the creek bed is steep and can be slippery ('dicey'), requiring care and using tree roots for stability (Photographers Trail Notes, Mountain State Waterfalls). Lower falls (#2-#4) are significantly more difficult to reach.",
      bestTimeOfDay: "Best photographed in early morning (sunrise) or late afternoon (sunset) to avoid harsh sunlight and deep shadows in the canyon (Loaded Landscapes). Overcast days are also ideal for even lighting on the water and mossy rocks (Photographers Trail Notes). Nighttime photography is also an option (Facebook).",
      bestTimeOfYear: "Year-round, with each season offering unique opportunities: Spring for high water flow, Autumn for colorful foliage and swirling leaves in the water (Loaded Landscapes), and Winter for ice formations and snow (WV Tourism). Autumn (early to mid-October) is particularly popular for the contrast of fall colors against the dark, tannic water (Facebook).",
      photographyTips: "A series of four falls, though #1 is the most photographed. Use a circular polarizer to eliminate glare from the water and rocks. Long exposures (1/4 to 2 seconds) are popular to create a 'swirl' effect in the pool at the base of the falls, especially when leaves are present. Compositions can be found from the front (right, center, left) or from a low angle in the creek. Be prepared for spray on the lens. The water has a distinctive red/amber hue due to tannic acid from hemlock and red spruce needles. Explore further downstream for falls #2, #3, and #4, which require more difficult scrambling and bushwhacking (Photographers Trail Notes, Loaded Landscapes, WV Tourism). The location is within Blackwater Falls State Park and is a series of four waterfalls on Shays Run. The information provided is based on the Photographers Trail Notes preview, Mountain State Waterfalls, and Loaded Landscapes. Note that the exact GPS coordinates provided by Photographers Trail Notes were partially obfuscated in the preview, but common coordinates for the falls were used to ensure accuracy.",
      shotDirection: "The falls generally flow towards the Blackwater Canyon. For Elakala #1, the shot is typically oriented looking upstream (roughly West or Northwest) towards the falls from the creek bed (Wikipedia).",
      lensesNeeded: "Ultra-wide angle (16-35mm range) is essential to capture the falls from the creek bed. Short to medium telephoto can be useful for details or tighter compositions (Photographers Trail Notes, Loaded Landscapes).",
      equipmentNeeded: "Sturdy but lightweight tripod, circular polarizer (to cut glare on water and wet rocks), lens cleaning supplies (microfiber cloths/towels) to handle spray, and potentially waterproof boots for standing in the creek (Loaded Landscapes, Photographers Trail Notes).",
      permits: "Generally none required for personal photography within the state park, but commercial photography may require a permit. Standard park entry fees may apply if not staying at the lodge (Photographers Trail Notes).",
      directions: "From Davis or Thomas, WV, follow signs to Blackwater Falls State Park. Turn onto Route 29 (Blackwater Falls Road) for 2.6 miles, then left onto Route 29/1 (Blackwater Lodge Road) for 1.5 miles. Park at the Blackwater Lodge parking lot. The Elakala Trail begins on the southern/left side of the lodge. A 5-minute walk leads to a bridge over the first falls. Cross the bridge and follow a steep, well-worn path 20-30 yards further down to the creek bed (Mountain State Waterfalls, Photographers Trail Notes).",
      camping: "Blackwater Falls State Park has 65 tent and trailer sites (30 with electric hookups), open late April to October 31 (Adventures of A+K). Nearby options include Canaan Valley Resort State Park and Five River Campground (Adventures of A+K).",
      lodging: "Blackwater Falls Lodge is located right at the trailhead. Cabins are also available within the park. Nearby towns of Davis and Thomas offer charming but limited lodging options (Islands, WV State Parks).",
      restaurants: "Full-service restaurant available at Blackwater Falls Lodge. Small selection of restaurants and grocery stores available in the nearby towns of Davis and Thomas (Islands, WV State Parks).",
      cellService: "Sketchy to poor cell service; Verizon is reportedly almost unusable in some areas of the park (Facebook). Offline maps are recommended (Adventures of A+K).",
      weather: "Best in overcast or 'flat' lighting. Be aware that water levels can change drastically after rain; high water flow may eliminate spots to set up a tripod in the creek bed (Photographers Trail Notes, Loaded Landscapes).",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/elakala-waterfall",
      photos: []
    },
    {
      name: "Folly Beach Pier",
      nearbyTown: "Folly Beach, SC (approx. 15 miles south of Charleston). Photographers Trail Notes",
      state: "South Carolina",
      region: "Eastern States",
      lat: "32.65518",
      lng: "-79.94037",
      elevation: "Sea Level (at the sand/beach where shots are taken). The pier structure itself stands approximately 22-23 feet above sea level. Photographers Trail Notes, SC Picture Project",
      trailDifficulty: "EASY (Rated 1 out of 5). The walk from the parking lot to the shooting location on the sand is short (2-5 minutes). The main challenge is managing sand on equipment. Photographers Trail Notes",
      bestTimeOfDay: "Sunrise is the primary recommended time to shoot, ideally with colorful clouds. Morning shoots often focus on using slow shutter speeds to capture the pier's undercarriage and the movement of the water. Photographers Trail Notes",
      bestTimeOfYear: "While accessible year-round, June and July are noted as times when the sun rises behind the pier from certain vantage points at low tide. Spring and summer offer warmer temperatures and more predictable skies, while fall (late September to early November) provides comfortable temperatures and fewer crowds. Photographers Trail Notes, Erin Rose Photography",
      photographyTips: "Use a slow shutter speed (e.g., 1.3 seconds or longer) to smooth out the water. Focus on the pier's undercarriage to create leading lines and perspective. Recommended settings include ISO 100 and a narrow aperture (f/20) for depth and long exposure. Midday long exposures (up to 45 seconds) can be achieved with heavy ND filters to soften waves. Arrive at least 45 minutes before sunrise to scout and set up. Photographers Trail Notes, Visual Wilderness The Folly Beach Pier was recently reconstructed and reopened in early 2023. The site mentions an outdoor spigot shower at the beach entrance which is useful for cleaning sand off gear. The pier is a iconic landmark in the South Carolina Lowcountry, stretching 1,045 feet into the Atlantic. It is noted for its ability to create wonderful compositions using its undercarriage and the surrounding surf. Photographers Trail Notes",
      shotDirection: "East / Southeast (facing the Atlantic Ocean for sunrise compositions). Visit Folly Beach",
      lensesNeeded: "Primarily an ultra-wide to medium telephoto location. An ultra-wide lens (e.g., 15mm) is ideal for perspective shots under the pier. Photographers Trail Notes",
      equipmentNeeded: "A sturdy tripod is essential for long exposures. Neutral density (ND) filters are recommended for smoothing water in daylight, and a circular polarizer is useful for reducing glare and enhancing colors. Photographers Trail Notes, Visual Wilderness",
      permits: "Parking fees apply at the pier lot (ranging from $15-$25 depending on the day and season). Daily fishing permits are $7 for adults and $4 for children/seniors. There is no fee for walk-ins or bicyclists to access the pier. Charleston County Parks",
      directions: "The pier is located 15 miles south of Charleston in the community of Folly Beach. Address: 101 E Arctic Ave, Folly Beach, SC 29439. Once parked, it is a two to five-minute walk to the sand underneath the pier. Photographers Trail Notes",
      camping: "Nearby camping is available at James Island County Park, which is a short drive from Folly Beach. Charleston County Parks",
      lodging: "Various hotels and vacation rentals are available within the Folly Beach community, including the Tides Folly Beach which is adjacent to the pier. Visit Folly Beach",
      restaurants: "Pier 101 Restaurant & Bar is located at the foot of the pier, along with a gift and tackle shop that serves concessions and ice cream. Charleston County Parks",
      cellService: "Good cell service is generally available throughout the Folly Beach community and at the pier location. Photographers Trail Notes",
      weather: "The location is subject to coastal conditions; hurricanes have historically damaged the pier. Summer months often bring afternoon thunderstorms, making sunrise the most stable time for photography. Photographers Trail Notes, Erin Rose Photography",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/folly-beach-pier",
      photos: []
    },
    {
      name: "Glade Creek Grist Mill (Babcock Mill)",
      nearbyTown: "Fayetteville, WV (approx. 20 miles). The Fun Times Guide",
      state: "West Virginia",
      region: "Eastern States",
      lat: "37.979561",
      lng: "-80.946399",
      elevation: "Approximately 2,500 feet (762 meters). The Fun Times Guide",
      trailDifficulty: "Easy (1/5): The mill is adjacent to the parking lot and visitor center. Trails around the mill are paved or involve easy steps. However, descending into the creek bed is slippery and requires caution and good footwear. Photographers Trail Notes",
      bestTimeOfDay: "Sunrise/Early Morning: Best with wet and foggy conditions for a saturated look. Avoid peak sun to prevent harsh shadows and high contrast on the mill and water. Early morning on weekdays is also better for avoiding crowds. Loaded Landscapes",
      bestTimeOfYear: "Fall (Late September to Late October): Peak autumn colors (typically mid-October) are iconic. Spring: Best for water flow and the small waterfalls in the foreground. Summer is also an option, but fall is the most popular. Loaded Landscapes, The Fun Times Guide",
      photographyTips: "Compositions: Numerous angles available. Shooting from downstream captures the waterfalls in the foreground. Shooting from the side near the parking lot uses rocks as foreground. Shooting from across the creek with a telephoto provides a clean perspective of the mill (but watch for people). Conditions: Best in wet, foggy, or overcast weather to minimize glare and maximize color saturation. Technique: Use long exposures for silky water effects. If shooting in the creek, aim for a perspective that doesn't lose the backdrop. Be careful to exclude the parking lot and cars when shooting from certain side angles. Photographers Trail Notes, Loaded Landscapes The mill is a 1976 replica of the Cooper's Mill and is fully functional. It is a very popular spot, so off-peak visits are recommended to avoid crowds. The water level is a key factor for the waterfalls; spring usually has the best flow. Freshly ground cornmeal may be available for purchase at the mill or visitor center. The location summary on the site was provided by David Long. Photographers Trail Notes",
      shotDirection: "The mill is generally photographed looking Upstream (North/Northeast) to capture the falls and the mill together. Shooting from the road/opposite side involves looking West/Southwest toward the mill. Loaded Landscapes",
      lensesNeeded: "Wide-angle (16-35mm or 20-22mm) for incorporating the walkway and foreground waterfalls. Short telephoto (70-80mm) for compressed scenes from across the creek or tighter shots of the mill. Photographers Trail Notes",
      equipmentNeeded: "Tripod (essential for long exposures of water), Polarizing Filter (to reduce glare on wet rocks and saturate colors), Hiking Poles (recommended if descending into the slippery creek bed), Waterproof Footwear/Boots with good traction. Photographers Trail Notes",
      permits: "Generally No Permit required for personal/recreational photography. However, commercial photography or filming requires a special use permit, proof of liability insurance ($1M minimum), and applicable fees (e.g., $200 processing fee). Full Frame Insurance",
      directions: "From Fayetteville, WV: Head northeast on US-19 North for approximately 7 miles. Take US-60 South for about 10 miles. Turn right on WV-41 South for 3.7 miles. Turn right onto Babcock Road and continue for about 0.5 miles to the mill parking lot. The mill is located adjacent to the park headquarters and visitor center. The Fun Times Guide",
      camping: "Babcock State Park Campground: Offers campsites and Wi-Fi for guests. Just Go Travel Studios",
      lodging: "Babcock State Park Cabins: 28 cabins available within the park. Nearby Fayetteville also offers various hotels and vacation rentals. Just Go Travel Studios",
      restaurants: "Babcock State Park Restaurant: Seasonal dining available within the park. Additional restaurants are located in nearby Fayetteville and Hinton. West Virginia State Parks",
      cellService: "Limited/Non-existent: Cellular reception is very limited in the Glade Creek Grist Mill area. Some visitors report it being almost non-existent for providers like Verizon. Wi-Fi is available at the park campground and cabins. Just Go Travel Studios",
      weather: "Foggy and wet conditions are ideal for photography. Area can be very warm and dry in the fall, which may affect foliage color and water levels. Check the local webcam for current conditions. Loaded Landscapes",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/babcock-mill",
      photos: []
    },
    {
      name: "Mabry Mill",
      nearbyTown: "Meadows of Dan, VA Photographers Trail Notes",
      state: "Virginia",
      region: "Eastern States",
      lat: "36.750902",
      lng: "-80.406007",
      elevation: "2,802 Ft. Photographers Trail Notes",
      trailDifficulty: "EASY. It is a very short walk (approx. 0.4 - 0.6 miles round trip) from the parking area to the photography locations. Photographers Trail Notes, Anne's Travels",
      bestTimeOfDay: "Sunrise and Sunset. Arrive at least 30 minutes before sunrise to secure a spot. Shortly after sunrise, light filters through trees creating highlights. For sunset, arrive 2.5 hours early to catch light on the narrow side before it's shaded, or wait until after sunset for even light. Photographers Trail Notes, Deb Snelson Photography",
      bestTimeOfYear: "Autumn (peak fall foliage) is the most popular; spring is recommended for blooming rhododendrons. Photographers Trail Notes, Deb Snelson Photography",
      photographyTips: "Position yourself on the right side of the slope for the best reflection. Look for a reflection that includes the entire roof of the mill. Use a slow shutter speed or continuous mode to capture the water turning the wheel. Avoid including the sky if it is clear blue and lacks interest. Shoot in soft overcast light to saturate fall colors and eliminate harsh shadows. Arrive early to get the best spots as it can be very busy. Photographers Trail Notes, Deb Snelson Photography The location is one of the most photographed spots on the Blue Ridge Parkway. Photography tips emphasize arriving early, especially during fall foliage peak, to secure a spot and capture the reflection in the pond. Soft overcast light or foggy mornings are also recommended to avoid harsh dappled light in the depression where the mill is located. Photographers Trail Notes, Deb Snelson Photography, Martin Belan",
      shotDirection: "The iconic shot faces the mill across the pond; light comes from the west at sunset, striking the narrow side. Deb Snelson Photography",
      lensesNeeded: "24-50 mm range for full-frame sensors; panoramas can be stitched for wider perspectives. Photographers Trail Notes",
      equipmentNeeded: "Tripod (sturdy but light), polarizer (to reduce glare and saturate colors), remote shutter release (for continuous mode to catch water movement), rain gear for camera and self, and a hand towel. Martin Belan, Deb Snelson Photography",
      permits: "None required (National Park Service site, but no specific photo permit listed as necessary). Anne's Travels",
      directions: "Located at Milepost 176.2 on the Blue Ridge Parkway. From the restaurant parking lot, take the paved 'Mountain Industry Trail' to the left to reach the mill. Anne's Travels, Martin Belan",
      camping: "Available nearby on the Blue Ridge Parkway (e.g., Rocky Knob Campground). Photographers Trail Notes, Facebook - BRP Photography Group",
      lodging: "Overnight stay options in Meadows of Dan, VA. Deb Snelson Photography",
      restaurants: "Mabry Mill Restaurant & Gift Shop is located directly at the site. Anne's Travels",
      cellService: "Little or no cell phone coverage in much of the park; downloading offline maps is recommended. Martin Belan",
      weather: "Expect rain, fog, and variable conditions. Fog is excellent for a moody effect. Rain/wind can quickly strip fall foliage. Martin Belan, Deb Snelson Photography",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/mabry-mill",
      photos: []
    },
    {
      name: "Old Orchard Beach Pier",
      nearbyTown: "Saco, ME (approx. 4 miles); Portland, ME (approx. 13 miles). Locationscout",
      state: "Maine",
      region: "Eastern States",
      lat: "43.5183",
      lng: "-70.3758",
      elevation: "Sea Level. Photographers Trail Notes",
      trailDifficulty: "EASY. The location is a flat, sandy beach. Access involves walking from paved areas onto soft sand. Photographers Trail Notes",
      bestTimeOfDay: "Sunrise is the ideal time to photograph the pier, as it offers the best light and the least amount of crowds. Early morning light provides a beautiful glow on the wooden structure and the surrounding water. The Outbound Collective Sunset also offers good light, particularly for reflections on the sand at low tide. Tripadvisor",
      bestTimeOfYear: "Year-round, but summer (mid-June to mid-September) is the busiest season with over 100,000 visitors. Seagrass Inn Early April is a great time for photography to capture the raw beauty of the beach without the summer crowds, though the pier shops may not be fully open. Seagrass Inn October sunsets are noted for gorgeous reflections on the ocean. Tripadvisor",
      photographyTips: "The most iconic shot is from standing under the pier to use the wooden pilings as leading lines. Adjusting shutter speed to capture different wave motion effects is highly recommended. Shooting at low tide provides the best access under the structure and can create beautiful reflections in the wet sand. Photographers Trail Notes Be careful when changing lenses due to blowing sand. Photographers Trail Notes Wide compositions from the beach capture the pier's scale, while shooting straight on from beneath the structure provides a symmetrical, graphic look. White Mountain Photography The pier is also a potential location for Milky Way photography due to its dark sky orientation over the ocean. Photography Magazine Extra The Old Orchard Beach Pier is a classic New England photography subject, particularly famous for its dramatic 'under the pier' leading lines and long exposure opportunities. The site is a popular destination with a 7-mile sandy beach and a boardwalk-style atmosphere. Photography is best done at sunrise to avoid the heavy crowds of the resort town. Photographers should be mindful of the tide, as many of the best compositions require standing in the surf. Cleaning equipment after the shoot is essential due to the fine sand and salt spray. Photographers Trail Notes",
      shotDirection: "The pier juts out into the Atlantic Ocean, so shots facing the end of the pier are generally East/South-East. Locationscout",
      lensesNeeded: "Wide-angle and standard length lenses offer the most flexibility. A 16-35mm or a 24-70mm (or equivalent) are ideal. Telephoto lenses up to 600mm can be used from the pier stairs to capture compressed beach scenes. Photographers Trail Notes, Facebook",
      equipmentNeeded: "A sturdy tripod is essential for long exposures. Waterproof boots (or going barefoot in summer) are recommended as you will likely get wet while shooting near the water. Lens cleaning supplies are necessary to remove fine sand and salt spray. Neutral Density (ND) filters are helpful for achieving motion effects in the waves during daylight. Photographers Trail Notes",
      permits: "No specific photography permits are listed, but expect to pay for parking in private lots or on the street, especially during the day. Parking is often $10.00 for the day, though arriving early for sunrise may allow for free or easier parking. Photographers Trail Notes, Tripadvisor",
      directions: "From Grand Avenue in Old Orchard Beach, look for the pier entrance. Walk from the pavement onto the beach next to the pier. The pier is centrally located in the downtown area, near Palace Playland. Photographers Trail Notes For GPS navigation, use the address 2 Old Orchard St, Old Orchard Beach, ME 04064. Photography Magazine Extra",
      camping: "The Old Orchard Beach Campground is located just a mile from the beach and is suitable for Class A and B RVs. A trolley service connects the campground to the town and pier area. Good Sam Camping Blog",
      lodging: "Numerous hotels and motels line the beach, including The Crest Hotel (35 East Grand Avenue). Photography Magazine Extra The area has a high density of lodging options due to its resort status. Tripadvisor",
      restaurants: "The pier itself has five restaurants and five bars, including the Old Orchard Beach Pier Restaurant at the end. Photographers Trail Notes Nearby options include Pier French Fries, Big Daddy's Bar & Grill, and Josephs By the Sea. Tripadvisor",
      cellService: "Available (standard resort town coverage). Photographers Trail Notes",
      weather: "Standard Maine coastal weather. Be prepared for cold sea air, especially in the early morning or outside of summer. Storms can bring dramatic surf but also hazardous conditions on the beach. White Mountain Photography Check local tide charts as the high tide can limit access under the pier. Seagrass Inn",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/old-orchard-beach-pier",
      photos: []
    },
    {
      name: "Old Stone Church",
      nearbyTown: "West Boylston, MA (church is within town limits); Worcester (approx. 7 miles south). Tripadvisor",
      state: "Massachusetts",
      region: "Eastern States",
      lat: "42.3747222",
      lng: "-71.7830556",
      elevation: "Approximately 395 ft (120 m) above sea level (Reservoir surface level). Wikipedia",
      trailDifficulty: "EASY. The most popular shot is a short, flat walk from the parking area along a causeway. A 10-minute walk leads to the church entrance. Some narrow side paths to the water's edge can be steep. Photographers Trail Notes, MassDayTripping",
      bestTimeOfDay: "Sunrise and Sunset are the primary recommended times. Before sunrise provides even light across the structure; after sunrise, the brick and flag (facing east) can be easily overexposed, though this can lead to dramatic shots depending on the sky. Sunset offers breathtaking light reflecting on the water. Weekday mornings are recommended to avoid crowds. Photographers Trail Notes, Airial Travel",
      bestTimeOfYear: "Fall is considered the best time (late September through mid-October, peak typically Oct 5–15) due to spectacular foliage framing the church. Summer is excellent as the sun sets directly down the reservoir. Winter is exceptional for snow-covered scenes; a giant wreath replaces the American flag in December. Photographers Trail Notes",
      photographyTips: "Use the array of trees to the right and behind the church to provide perfect balance and framing. On still days, the reservoir provides a perfect mirror reflection. For a classic shot, photograph from the MA-140 overpass or the causeway. Go inside the church to utilize the open columns for dramatic shadow and light contrast. In the fall, explore the narrow, winding trails at Wachusett Reservoir for intimate foliage shots. Long exposures are effective for smoothing water and clouds. Be careful not to overexpose the brick and the American flag (on the east side) when they are in direct morning sun. Photographers Trail Notes, Discover Central MA, MassDayTripping The Old Stone Church is a historic remnant of the village of West Boylston, which was flooded in the early 1900s to create the Wachusett Reservoir. The church is now a shell with no interior fixtures, featuring dirt floors and high beams. It is on the National Register of Historic Places. Portable latrines are available on-site. Visitors should be mindful of private events like weddings (restricted to 25 people or fewer by DCR) which may temporarily limit interior access. In summer, be cautious of poison ivy and bugs on the narrow trails parallel to the water. Drone photography is common but operators should check local DCR regulations. Photographers Trail Notes, MassDayTripping",
      shotDirection: "Primarily West/Southwest for sunset shots across the water, or East for sunrise shots illuminating the church facade and flag. MassDayTripping",
      lensesNeeded: "A longer lens (70mm to 250mm) is recommended for close-ups of the church and flag. A wide-angle lens is needed to capture the church within the context of the expansive reservoir and sky. Photographers Trail Notes",
      equipmentNeeded: "A full camera bag is recommended as the walk is short. A tripod is highly recommended for low-light and sunset shots. ND filters are useful for smoothing out the reservoir water for mirror reflections. Photographers Trail Notes, Airial Travel",
      permits: "Free admission. No official permits are required for individuals or groups under 25 people. No dogs or animals are allowed on the property. Bodily contact with the reservoir water is prohibited. West Boylston Historical Society",
      directions: "The church is located at 130 Beaman Street, West Boylston, MA. From I-190 or I-290, take the exit for MA-140. Continue on MA-140, which becomes Beaman Street. There is a small dirt pull-off for 5–6 vehicles about a half-mile past the Massachusetts State Fish/Wildlife facility. Additional paved parking is available on Beaman Street near the church. The main shot location is a short walk from the parking area along the causeway. MassDayTripping",
      camping: "No camping is permitted on-site at the Wachusett Reservoir. Nearby options include Indian Ranch (Webster, ~20 miles) or state parks in the wider Central Massachusetts area like Wells State Park (Sturbridge, ~25 miles). Tripadvisor",
      lodging: "The Rose Cottage Bed & Breakfast (0.2 mi), Classic Suites & Inns (1.4 mi). More extensive options are available in nearby Worcester (6–7 miles), including the Beechwood Hotel and Hampton Inn & Suites. Tripadvisor",
      restaurants: "Country Kettle (0.3 mi), Cheoy Lee's II (0.4 mi), Bamboo Garden (0.4 mi), Shannon's Pizza (0.5 mi), Draught House Bar & Grill (1.0 mi), and The Mill (1.7 mi). Tripadvisor",
      cellService: "Good/Excellent. The location is in a developed area of West Boylston near major routes (MA-140 and MA-12). MassDayTripping",
      weather: "Excellent in all seasons. Snowy conditions in winter create an ethereal atmosphere. Fall foliage peak is weather-dependent but usually mid-October. Summer can be hot, and drought conditions may lower reservoir levels, affecting reflections. Photographers Trail Notes",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/old-stone-church",
      photos: []
    },
    {
      name: "Pemaquid Point Lighthouse",
      nearbyTown: "New Harbor (immediate vicinity); Damariscotta (approx. 13.7 miles). Photographers Trail Notes",
      state: "Maine",
      region: "Eastern States",
      lat: "43.8371667",
      lng: "-69.5060833",
      elevation: "79 Ft. Photographers Trail Notes",
      trailDifficulty: "Moderate. The area near the parking lot is very easy and level, but paths leading down the rocky slope toward the water are moderate. Photographers Trail Notes",
      bestTimeOfDay: "Great any time. At sunrise in the winter, the sun rises out over the water. During the summer, it is a fantastic night sky location as the Milky Way rises over the water. Midday also lends itself to great photos. Photographers Trail Notes",
      bestTimeOfYear: "Great all year round. In the summer, the park is more crowded, but crowds thin out at sunrise and sunset. Photographers Trail Notes",
      photographyTips: "Use puddles on the rocky slope for reflection elements. Location #2 (just below the lighthouse looking up) is best captured at 16mm. Location #3 (facing the lighthouse from the east looking west) is best at 24mm. The metamorphic rock provides unique leading lines. Photographers Trail Notes The park is open 24 hours a day with no gate. Expect up to eight other photographers on busier days, and many general visitors during midday. The metamorphic rock at the site provides excellent leading lines and textures for compositions. Photographers Trail Notes",
      shotDirection: "Varies; the main shot is northeast around 30°. Photographers Trail Notes",
      lensesNeeded: "Wide-angle lenses are most useful; standard length lenses up to 100mm can also be used. Specific shots mentioned using 16mm and 24mm. Photographers Trail Notes",
      equipmentNeeded: "Camera, wide-angle and standard length lenses, tripod, and filters if desired. Photographers Trail Notes",
      permits: "Advertising, commercial photography, and filming require a permit handled by the Town of Bristol. Photographers Trail Notes",
      directions: "From Damariscotta: Drive south on ME-129 S/Bristol Rd for 2.2 miles, then take a slight left onto ME-130 S for 11.5 miles. From Brunswick: Drive on US-1 for 25 miles (through Wiscasset) and take the exit toward ME-130 toward Pemaquid. Photographers Trail Notes",
      camping: "Pemaquid Point Campground (Seasonal, 1.5 miles); Sherwood Forest Camp Site (Seasonal, 7 miles). Photographers Trail Notes",
      lodging: "The Hotel Pemaquid (Seasonal, 3098 Bristol Road, New Harbor, ME 04554, 207-677-2312); The Bradley Inn (3063 Bristol Road, New Harbor, Maine 04554, 207-677-2105). Photographers Trail Notes",
      restaurants: "The Bradley Inn (207-677-2105); Shaw’s Wharf Fish & Lobster (207-677-2200). Photographers Trail Notes",
      cellService: "Verizon service is inconsistent (in and out), with one or two bars at best. Photographers Trail Notes",
      weather: "Marine weather forecast available at weather.gov. Photographers Trail Notes",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/pemaquid-point-lighthouse",
      photos: []
    },
    {
      name: "Portland Head Lighthouse",
      nearbyTown: "Cape Elizabeth, ME (close to downtown Portland) Photographers Trail Notes",
      state: "Maine",
      region: "Eastern States",
      lat: "43.6231111",
      lng: "-70.2078611",
      elevation: "Sea Level Photographers Trail Notes",
      trailDifficulty: "EASY TO MODERATE. Options range from easy postcard views near the parking lot to moderate scrambles down rocks for more dramatic angles. Rocky areas can be dangerous due to slick surfaces and unpredictable waves. Photographers Trail Notes",
      bestTimeOfDay: "Sunrise is the prime time to shoot as the sun rises over the water all year round and crowds are smaller. The park gate typically opens at sunrise and closes at sunset. Sunset can also be excellent if the sky is favorable, but the park enforces closure shortly after sunset, making evening blue hour or star photography unlikely. Photographers Trail Notes",
      bestTimeOfYear: "Photogenic year-round. Early summer (June) features yellow wildflowers; late summer brings beach roses in full bloom. Winter offers unique opportunities with snow and ice. Summer is the busiest season for visitors and photographers. Photographers Trail Notes",
      photographyTips: "There are numerous angles available. Location #1: A dramatic cliff view from the north looking south toward the lighthouse; lower tides are preferred to access rocks below the cliffs. Location #2: Found at the far end of the rocks south of the lighthouse by following the footpath; this spot often looks best at high tide. Traditional views are also available from the north. For waterscapes, aim to capture the receding wave. Example settings used: f/13, 20-second exposure, ISO 100. It is recommended to familiarize yourself with the area before arriving in the dark. Photographers Trail Notes The park is maintained by the town of Cape Elizabeth and supported by the Friends of Williams Park. Visitors are asked to respect the natural resources, fencing, and stay on trails. Be mindful of unpredictable waves and slick rocks, which can be dangerous. Check the tide chart and official webcam for current conditions. Photos and location summary are by Matt Reynolds. Photographers Trail Notes",
      shotDirection: "Around 150° for Location #1 (facing south) and 20° - 30° for Location #2 (facing north). Photographers Trail Notes",
      lensesNeeded: "Primarily a wide-angle location (e.g., 16-35mm on a full-frame camera). Focal lengths around 16mm are common for dramatic foregrounds. Normal or long lenses can be used if waves are too rough to approach the shoreline safely. Photographers Trail Notes",
      equipmentNeeded: "Steady tripod, neutral density (ND) filters (for exposures up to 20 seconds), proper footwear for walking on potentially slick rocks, and bug spray during summer months. Photographers Trail Notes",
      permits: "Advertising, commercial photography, and filming require a permit from the town. Drones were permitted as of February 2020 but are subject to current regulations. Photographers Trail Notes",
      directions: "Located at the end of Fort Williams Park at 12 Captain Strout Cir, Cape Elizabeth, ME 04107. There is no admission fee to the park, but parking is $4 for two hours and $2 for each additional hour. Note that there is a gate at the park entrance. Photographers Trail Notes",
      camping: "While specific campgrounds aren't listed, lodging of all kinds is noted as abundant in nearby downtown Portland. Photographers Trail Notes",
      lodging: "Abundant lodging of all kinds is available in nearby downtown Portland. Photographers Trail Notes",
      restaurants: "Portland has a strong foodie culture. Nearby options include Eventide Oyster Company, Shipyard Brewing Company, and Street & Co.. Photographers Trail Notes",
      cellService: "Good coverage is available in both the parking area and at the lighthouse. Photographers Trail Notes",
      weather: "Pleasant to cool in Fall/Spring; hot in Summer but with generally perfect sunsets; Winter can bring snow and ice. Photographers Trail Notes",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/portland-head",
      photos: []
    },
    {
      name: "Rainbow Falls, Watkins Glen",
      nearbyTown: "Watkins Glen, NY Photographers Trail Notes",
      state: "New York",
      region: "Eastern States",
      lat: "42.36721",
      lng: "-76.901886",
      elevation: "795 Ft. Photographers Trail Notes",
      trailDifficulty: "Moderate. The Gorge Trail is stone with many steps (over 800 steps total). Hiking down is easy, but hiking up is physically demanding. The trail is often wet and can be slippery. Photographers Trail Notes John Clark Photography",
      bestTimeOfDay: "Early morning (sunrise) or late afternoon/evening. Early morning (7:00 AM - 9:00 AM) is preferred to avoid the 'wandering hordes' and capture the best light in the deep gorge. Overcast days are also ideal as they eliminate harsh shadows in the narrow gorge. Photographers Trail Notes Soltrav",
      bestTimeOfYear: "May through November (when the Gorge Trail is open). Late October is specifically recommended for fall colors and smaller crowds. The Gorge Trail typically closes from November to mid-May. Photographers Trail Notes Soltrav",
      photographyTips: "Use a polarizer to manage reflections on wet rocks and enhance the green of the moss. Long exposures are key for the silky water effect, requiring a tripod. Small adjustments in position (even a few feet) can significantly change the composition. Horizontal and vertical compositions both work well for Rainbow Falls. Be prepared for moisture on the lens from the waterfall spray. For Cavern Cascade, try using the cavern entrance to frame the waterfall. Arrive at opening time to avoid crowds. Photographers Trail Notes John Clark Photography Soltrav The Gorge Trail is a stone trail with many steps and is often wet and slippery. The park features 19 waterfalls in total. The 'Rainbow Falls' shot is the most iconic, featuring a bridge and falling water. It is recommended to stay close to your camera at all times due to high foot traffic. Photographers Trail Notes",
      shotDirection: "The iconic Rainbow Falls shot is generally oriented looking into the gorge (westward/northwestward as the creek flows towards Seneca Lake), but specific compass directions vary by waterfall. Photographers Trail Notes",
      lensesNeeded: "24-70mm lens (specifically 40mm and above) is highly recommended. Wide-angle lenses (like 16-35mm) can be useful but may include too much of the crowded trail. A telephoto lens is useful for tighter shots of the falls. Photographers Trail Notes Landscape Photography Magazine",
      equipmentNeeded: "Tripod (essential for long exposures of waterfalls), polarizer (to bring out colors in moss/foliage and reduce glare on wet rocks), and a microfiber cloth (to clean moisture/mist from the lens). Photographers Trail Notes Soltrav",
      permits: "Vehicle entry fee for Watkins Glen State Park (typically $10 per vehicle). No specific photography permit is mentioned for personal use. Soltrav",
      directions: "The park is located in the village of Watkins Glen. You can park at the Lower Entrance in the village and walk up the Gorge Trail. Alternatively, during the season, a shuttle bus runs from the village parking area to the top of the gorge (Mile Point). If the shuttle is not running, hikers must do a round trip, often ascending the Gorge Trail and descending via the Indian Trail or vice versa. Photographers Trail Notes",
      camping: "Nearby camping is available within Watkins Glen State Park and the surrounding Finger Lakes region. Photographers Trail Notes",
      lodging: "Nearby lodging is available in the village of Watkins Glen and the surrounding Finger Lakes area. Photographers Trail Notes",
      restaurants: "Numerous restaurants and food options are available in the village of Watkins Glen, adjacent to the park entrance. Photographers Trail Notes",
      cellService: "Cell service is available but may be limited or spotty within the deep sections of the gorge. Photographers Trail Notes",
      weather: "Best for photography on overcast or slightly rainy days to avoid high contrast and harsh shadows. Moisture is constant in the gorge, so protect gear. Soltrav",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/watkins-glen",
      photos: []
    },
    {
      name: "Sandwich Boardwalk",
      nearbyTown: "Sandwich, MA (The location is within the town). Photographers Trail Notes.",
      state: "Massachusetts",
      region: "Eastern States",
      lat: "41.7683333",
      lng: "-70.485",
      elevation: "Sea Level. Photographers Trail Notes.",
      trailDifficulty: "Easy (Rated 1-2 on a scale of 1-5). The boardwalk starts at the parking lot and is very accessible. The main challenge is potential mud if venturing off the boardwalk into the marsh. Photographers Trail Notes.",
      bestTimeOfDay: "Primarily a sunrise location. It looks best with colorful clouds reflecting in the water of the creek and marsh. Shooting about 10 minutes before sunrise can capture optimal light and reflections. A still morning with little wind is preferred for better water reflections. Photographers Trail Notes.",
      bestTimeOfYear: "Accessible year-round, but \"shoulder seasons\" (Spring/Fall) are highlighted as periods where checking for high tides is particularly important for the best imagery. Photographers Trail Notes.",
      photographyTips: "Use the boardwalk, creek, and marsh as leading lines to create strong compositions. A higher tide is generally optimal as the marsh fills with water, creating better reflections, although colorful clouds are the most important factor. The area is small enough that you can find a composition quickly before sunrise without prior scouting. Shooting from the boardwalk or standing in the marsh mud offers different angles; however, be aware that marsh mud is very slippery and can have a strong odor at low tide. For wide vistas, consider a vertical panorama (e.g., a 6-shot pano at 21mm) to capture the curve of the creek. Photographers Trail Notes. The Sandwich Boardwalk is a historic 1,350-foot wooden structure that has been a landmark in Sandwich since 1875. It has recently undergone a complete reconstruction, with the new boardwalk opening for the 2026 season. It is a popular spot not only for photography but also for the local tradition of jumping into Mill Creek at high tide. Note that the marsh area can have a strong odor at low tide, and the mud is extremely slippery. Protecting the sand dunes at the end of the boardwalk is critical, and they are strictly off-limits. Photographers Trail Notes, Town of Sandwich, Linda Whitcomb Cape Cod.",
      shotDirection: "Generally East/Northeast looking over the marsh toward the sunrise. Facebook Photography Groups.",
      lensesNeeded: "Primarily a wide-angle or normal focal length spot (e.g., 21mm prime or 24-70mm zoom). Wide lenses are used to emphasize the foreground elements like the boardwalk or marsh. Photographers Trail Notes.",
      equipmentNeeded: "Tripod, Circular Polarizer, and a 3-stop Neutral Density (ND) filter are recommended to smooth out water and manage reflections. Photographers Trail Notes.",
      permits: "Non-resident day parking pass is $25; resident stickers are $20. Parking is free after 5:00 PM (ideal for evening/sunset visits, though sunrise is preferred). Town of Sandwich, Linda Whitcomb Cape Cod.",
      directions: "The boardwalk starts at a parking lot located at 103 Wood Ave, Sandwich, MA. From the parking lot, you can be out of your car and shooting in minutes. The boardwalk spans across a creek and marsh, ending at Town Neck Beach. Photographers Trail Notes, Waze.",
      camping: "Five campsites are available on the Coastal Trail on a first-come, first-served basis (note: this may refer to the nearby Cutler Coast area mentioned in the same guide series, but general Cape Cod camping is available nearby at Scusset Beach State Reservation). Photographers Trail Notes.",
      lodging: "The Dan'l Webster Inn & Spa and Belfry Inne and Bistro are located in nearby Sandwich. Tripadvisor.",
      restaurants: "Marshland Restaurants & Bakeries, The Dan'l Webster Inn Restaurant, and Belfry Inne and Bistro are highly rated nearby. Tripadvisor.",
      cellService: "Available (listed as a standard data point for this location in the guide). Photographers Trail Notes.",
      weather: "Best with colorful clouds for reflections. Still mornings with no wind are ideal for smooth water. It is imperative to check tide times as tides move in fast and can significantly change the landscape. Photographers Trail Notes.",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/sandwich-boardwalk",
      photos: []
    },
    {
      name: "The Tarn",
      nearbyTown: "Bar Harbor (approx. 2 miles / 6-minute drive) Photographers Trail Notes",
      state: "Maine",
      region: "Eastern States",
      lat: "44.3516111",
      lng: "-68.2041667",
      elevation: "101 Ft. Photographers Trail Notes",
      trailDifficulty: "Easy (Rating: 1 on a scale of 1-5). The shooting location is a very short walk from the road. Photographers Trail Notes",
      bestTimeOfDay: "Mid-morning. It is not necessarily a sunrise shot; the best approach is to wait for the sun to clear Huguenot Head and illuminate the color-bearing trees on Dorr Mountain, which typically occurs mid-morning. Photographers Trail Notes",
      bestTimeOfYear: "Autumn/Fall (typically October) is the best season to capture the vibrant foliage colors reflecting in the water. Photographers Trail Notes | Vern Clevenger",
      photographyTips: "Wait for the sun to clear Huguenot Head and light up the side of Dorr Mountain. Use a polarizer to cut glare and enhance the colors of the water and foliage, but rotate it carefully to maintain the desired strength of the reflections. Look for compositions featuring lily pads and water grasses as foreground elements. Longer focal lengths (70-200mm) are excellent for isolating intimate details of the reeds and reflections. Photographers Trail Notes | I Hit The Button The Tarn is a shallow, under-appreciated pond in Acadia National Park that offers exceptional reflections, particularly in the fall. It is located in a steep valley between Dorr Mountain and Huguenot Head. While it lacks a formal parking lot, it is easily accessible via roadside pull-offs. Photographers Trail Notes | Nature TTL",
      shotDirection: "Westward (toward Dorr Mountain) or Southwest. Photographers Trail Notes",
      lensesNeeded: "Wide-angle to telephoto lenses are useful. Focal lengths like 24-70mm and 70-200mm are recommended. Many intimate shots of lily pads and reflections are taken around 150mm. Photographers Trail Notes",
      equipmentNeeded: "Tripod, Polarizer, and ND Filter (useful for longer exposures during low light). I Hit The Button",
      permits: "A valid Acadia National Park entrance pass is required. Commercial photography or filming may require a Special Use Permit. NPS.gov",
      directions: "From Bar Harbor, drive south on ME Route 3 for approximately six minutes. The Tarn sits along the road past Sieur de Monts. There is no formal parking area; photographers typically pull off and park on the shoulder of Route 3 just south of the pond. Ensure your vehicle is completely out of the travel lane. From the pull-off, it is a short walk of 100 yards or less to the water's edge. Alternatively, you can walk the 0.5-mile Kane Path from Sieur de Monts. Photographers Trail Notes | Maine by Foot",
      camping: "Blackwoods Campground is the nearest major campground in Acadia National Park. YouTube: Hiker Trash Husbands",
      lodging: "Extensive options available in the nearby town of Bar Harbor. Photographers Trail Notes",
      restaurants: "Numerous restaurants are located in nearby Bar Harbor. Photographers Trail Notes",
      cellService: "Generally available due to its proximity to Bar Harbor and Route 3. Photographers Trail Notes",
      weather: "Check local forecasts for Acadia; fog can provide a moody atmosphere at sunrise, but mid-morning light is typically preferred for reflections. Surfaces near the water can be slippery when wet. Benjamin Williamson | I Hit The Button",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/the-tarn",
      photos: []
    },
    {
      name: "Two NYC Icons in One Shot",
      nearbyTown: "Bayonne, NJ Source Page",
      state: "New Jersey",
      region: "Eastern States",
      lat: "40.6636667",
      lng: "-74.0688611",
      elevation: "Sea Level Source Page",
      trailDifficulty: "EASY Source Page",
      bestTimeOfDay: "Sunset, Late afternoon, Sunrise. Sunrise and sunset are ideal for beautiful light. The statue is best captured when illuminated by the sun's golden hour rays or by artificial lights, which highlight the torch's 24K gold flame and create a warm glow on the pedestal. Note that there is a transitional period at sunset where the sun no longer hits the statue but artificial lights haven't come on yet, which can be challenging. Multiple skyscrapers like the Empire State Building also feature decorative LED lighting. Source Page",
      bestTimeOfYear: "The location can be photographed anytime of year. The specific example image was taken on November 24th. Source Page",
      photographyTips: "Landscape Composition: Shoot from Harbor View Park. Position the Statue of Liberty facing toward the Empire State Building. Try to maintain separation between the statue and the buildings behind it. Portrait Composition: Drive to the end of the pier to the north where the road bends. Position the Statue of Liberty to the right of the Empire State Building, framing the building within a gap in the skyline. General: Be mindful of cruise ships and ferries in the harbor. Small movements in your position significantly impact the alignment of the landmarks. Source Page The location summary mentions that photographers may encounter cruise ships or ferries which can add activity or be distracting. There are typically few other photographers, though people fishing may be present. The skyline is constantly evolving, so compositions may change over time. Source Page",
      shotDirection: "Northeast, approximately 35°. Source Page",
      lensesNeeded: "Longer lenses in the 500mm to 600mm range are recommended to make the landmarks appear closer and of similar size. A 250mm lens can be used for wider skyline views, though the statue may lose its prominence. The featured image was taken at 535mm. Source Page",
      equipmentNeeded: "A tripod is required due to the long focal lengths and low light conditions. Source Page",
      permits: "No permit is required. Source Page",
      directions: "Drive along Port Terminal Boulevard to the parking lot at the eastern end of the Peninsula at Bayonne Harbor (formerly Military Ocean Terminal). You will pass the Cape Liberty Cruise Port. On cruise embarkation days (Fri-Sun), traffic may be heavy; stay straight toward the end of the pier rather than following parking traffic. The park entrance is at the southeast end of the parking lot, followed by a short walk to the lawn. Source Page",
      camping: "None listed on the page.",
      lodging: "None listed on the page.",
      restaurants: "None listed on the page.",
      cellService: "Strong cell service is available at this location. Source Page",
      weather: "Current weather can be checked via the National Weather Service. Source Page",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/two-nyc-icons-in-one-shot",
      photos: []
    },
    {
      name: "Willard Beach",
      nearbyTown: "South Portland, Maine",
      state: "Maine",
      region: "Eastern States",
      lat: "43.6421111",
      lng: "-70.2266667",
      elevation: "Sea Level Ft. Elevation",
      trailDifficulty: "EASY. Short walk (approx. 1/4 mile) from the parking area to the beach, transitioning from pavement to soft sand.",
      bestTimeOfDay: "Good at any time of day, but sunrise and sunset offer the most dramatic light. Sunrise is recommended for subjects like the fishing shacks and the shot with Portland Head Lighthouse. Sunset is good for Spring Point Ledge lighthouse and the dory. Low tide allows walking further out for reflections on wet sand; high tide requires photographing from further away.",
      bestTimeOfYear: "Great year-round. Spring, summer, and early fall feature boats moored in Simonton Cove. Winter can be magical for photographing 'sea smoke' (fog rising off the water) on the coldest days with single-digit or negative temperatures (Fahrenheit).",
      photographyTips: "For sea smoke shots, walk out onto the beach and choose a composition. Both the lighthouse and shack images are taken along the beach. For the red sunrise image (stacking Portland Head Light behind the fishing shacks), walk to the north end of the beach and climb steps up to the Southern Maine Community College campus for the proper angle. Reflections of the shacks can be captured in wet sand at low tide. Standard zoom (24-70) and telephoto (100-400 or 150-600) lenses are recommended for compression. The Willard Beach fishing stacks (shacks) were destroyed in a storm in the winter of 2023; the city plans to rebuild them but no timeframe is set. From the north end of the beach, Portland Head Lighthouse is visible behind the fishing shacks. Spring Point Ledge Lighthouse and Fort Preble (built in 1808) are at the north end of the beach. Visit Portland and Rick Berk are mentioned as additional resources. Good coverage of photographers in the parking area and at the beach can be expected.",
      shotDirection: "Mainly southeast around 105°.",
      lensesNeeded: "Standard length zoom (24-70mm) and telephoto zooms (100mm-400mm or 150mm-600mm). Longer focal lengths (e.g., 143mm) are useful for compressing perspective, specifically for the shot of Portland Head Lighthouse behind the fishing shacks.",
      equipmentNeeded: "A sturdy tripod.",
      permits: "There are no permits required in the area.",
      directions: "From the Willard Beach parking area, it is an easy 1/4 mile walk to the beach. The walk transitions from pavement to soft sand. Once on the beach, the shacks at Fisherman's point are to the right (south), and Spring Point Ledge and Fort Preble are to the left (north). Driving Directions",
      camping: "The lighthouse is close to downtown Portland and lodging of all kinds is abundant. (Specific camping sites not listed, implies general proximity to Portland).",
      lodging: "Abundant lodging of all kinds in nearby downtown Portland.",
      restaurants: "Portland has a strong foodie and beer brewing culture. Specific recommendations: Eventide Oyster Company ((207) 774-8538, 86 Middle St, Portland), Shipyard Brewing Company ((207) 761-0807, 86 Newbury St, Portland), Street & Co. ((207) 775-0887, 33 Wharf St, Portland).",
      cellService: "Cell service is strong.",
      weather: "Pleasant to cool in Fall and Spring. Hot in Summer with generally perfect sunset weather. Winter can be extremely cold with snow and ice; ocean water is very cold even in summer. Take extra care in dress and safety precautions in winter. Current Weather",
      sourceUrl: "https://photographerstrailnotes.com/eastern-states/willard-beach",
      photos: []
    }
